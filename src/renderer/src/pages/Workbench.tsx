...
export default function Workbench(): JSX.Element {
  ...
  const [currentPage, setCurrentPage] = useState<WorkbenchTab>('chat')
  ...
  function renderContent(): JSX.Element {
    switch (currentPage) {
      case 'gallery':
        ...
        return <ControlPanel />
      case 'chat':
        return <Chat thread={activeThread} isRunning={isRunning} />
      case 'control-panel':
        return <ControlPanel />
      case 'agents':
        return <Agents />
    ...
    <div className="flex h-screen flex-col bg-neutral-900 text-white">
      ...
      <div className="flex min-h-0 flex-1 overflow-hidden">
        ...
        <main className="min-w-0 flex-1 overflow-hidden">
          ...
          <div className="h-[calc(100%-3rem)] overflow-hidden">{renderContent()}</div>
