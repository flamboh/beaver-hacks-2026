...
export default function SideBar({ currentPage, projectName, open, setCurrentPage }: Props) {
	...
	return (
		<div
			className="h-full bg-neutral-900 border-r border-white/5 flex flex-col shrink-0 overflow-hidden transition-all duration-200 ease-in-out"
			style={{ width: open ? 200 : 0 }}
		>
			{/* inner wrapper keeps content from collapsing mid-animation */}
